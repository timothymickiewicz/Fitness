...
function Workout(props) {
    ...
    return (
        <div className="row workoutContainer">
            ...
            <div className="row content">
                <div className="row section">
                    ...
                    <select name="exercises" id="exercises">
                        ...
                        :
                            (
                                <option id="exercises" key={0} disabled={true} value="No Workouts Created">No Workouts Created</option> 
                            )
                        }
                    </select>
                </div>
                <div className="row section">
                    ...
                    <input id="setSets" onChange={(e) => setSets(e.target.value)} className="inputBox">
            ...
            onClick={() => {
                handleSetWeights(); handleSubmitWorkout();
                }}>
                    Submit
            </button>
        </div>
