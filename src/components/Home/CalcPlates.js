        ...
        <div className="row">
            ...
            <div className="row">
                <div className="col-12">
                    <input className="inputBoxCalc" onChange={(e) => {handleWeightChange(parseInt(e.target.value)); setHandleSendData(false)}}>
                ...
                <div className="row">
                    <div className="col-12">
                        <button className="submitWeightCheck" onClick={() => {checkWeight(weight); handleSendData()}}>Calculate</button>
                    </div>
                </div>
                {
                    toggleSendData ?
